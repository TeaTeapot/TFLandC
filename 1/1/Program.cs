...
• Вызов справки - открывает данное окно справки
  Содержит подробное описание всех реализованных функций.
...
ИНТЕРФЕЙС ПРОГРАММЫ
===========================================
Программа разделена на две основные области:
1. Верхняя область - редактирование текста
   Поддерживает многострочный ввод, табуляцию,
   автоматическую прокрутку при необходимости.

2. Нижняя область - вывод результатов
   Предназначена для будущего языкового процессора.

Размер областей можно изменять, перетаскивая разделитель между ними.
Окно программы можно изменять в размерах, установлен минимальный размер 500x400 пикселей.";
